...
<script>
import { addData, delData, exportData, getData, listData, updateData } from "@/api/admin/system/dict/data";
import { getType, listType, clearCache } from "@/api/admin/system/dict/type";
