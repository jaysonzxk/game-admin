...
<script>
import { getGenTable, updateGenTable } from "@/api/admin/tool/gen";
import { optionselect as getDictOptionselect } from "@/api/admin/system/dict/type";
import { listMenu as getMenuTreeselect } from "@/api/admin/permission/menu";
