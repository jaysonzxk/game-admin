    ...
    <div class="app-container">
        <el-row>
            <el-col :span="20" :xs="24">
                ...
                <el-table v-loading="loading" :data="amountConfigList" @selection-change="handleSelectionChange">
                    <el-table-column label="序号" type="index" width="50" align="center">
                    </el-table-column>
                    <el-table-column label="配置名称" align="center" prop="name" :show-overflow-tooltip="true" />
                    <el-table-column label="会员价" align="center" prop="discountAmount" :show-overflow-tooltip="true" />
                    <el-table-column label="原价" align="center" prop="discountAmount" :show-overflow-tooltip="true" />
                    ...
                    <el-table-column v-if="hasPermi(['pay:amountConfig:add:post', 'pay:amountConfig:update:post'])" label="操作"
                        align="center" width="160" class-name="small-padding fixed-width">
                        <template slot-scope="scope">
                            <el-button v-hasPermi="['pay:amountConfig:update:post']" size="mini" type="text"
        ...
        <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="会员价" prop="discountAmount">
                            <el-input type="number" v-model="form.discountAmount" placeholder="会员价" maxlength="11" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
...
import {
    ...
    addAmountConfig,
    updateAmountConfig
} from "@/api/admin/payChannel/amount";
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            listAmountConfig(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
                this.amountConfigList = response.data.results;
        ...
        handleUpdate(row) {
            ...
            getAmountConfig(id).then(response => {
            ...
            this.$refs["form"].validate(valid => {
                if (valid) {
                    if (this.form.id !== undefined) {
                        updateAmountConfig(this.form).then(response => {
                            this.msgSuccess("修改成功");
                            this.open = false;
                            this.getList();
                        });
                    } else {
                        addAmountConfig(this.form).then(response => {
