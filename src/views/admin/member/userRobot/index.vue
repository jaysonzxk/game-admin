    ...
    <div class="app-container">
        <el-row>
            ...
            <el-col :span="20" :xs="24">
                ...
                <el-table v-loading="loading" :data="userRobotList" @selection-change="handleSelectionChange">
                    ...
                    <template slot-scope="scope">
                        <span v-if="scope.row.isExpiration">已到期</span>
...
import {
    ...
    getUserRobot,
    updateUserRobot
} from "@/api/admin/member/userRobot";
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            listUserRobot(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
                this.userRobotList = response.data.results;
            ...
            this.$refs["form"].validate(valid => {
                if (valid) {
                    if (this.form.id !== undefined) {
                        updateUserRobot(this.form).then(response => {
